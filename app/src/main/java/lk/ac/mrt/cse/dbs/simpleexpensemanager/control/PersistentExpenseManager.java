...
public class PersistentExpenseManager extends ExpenseManager {
    ...
    @Override
    public void setup(){
        TransactionDAO persistentTransactionDAO = new PersistentMemoryTransactionDAO(DBHelper);
        setTransactionsDAO(persistentTransactionDAO);

        AccountDAO persistentAccountDAO = new PersistentMemoryAccountDAO(DBHelper);
